 ...
 * {@link InfoCompteFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link InfoCompteFragment#newInstance} factory method to
...
public class InfoCompteFragment extends Fragment {
     ...
     * @return A new instance of fragment InfoCompteFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            txtCompte.setText("Bonjour " + personne.getPrenom() + " " + personne.getPrenom());
        }
        return view;
    }
